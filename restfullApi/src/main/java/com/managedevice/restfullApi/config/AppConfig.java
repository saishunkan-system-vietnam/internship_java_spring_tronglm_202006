package com.managedevice.restfullApi.config;
...
@Configuration
@ComponentScan(basePackages = { "com.managedevice.restfullApi.service" })
public class AppConfig {
	...
	public MapperScannerConfigurer mapperScannerConfigurer() {
		...
		mapperScannerConfigurer.setBasePackage("com.managedevice.restfullApi.mapper");
